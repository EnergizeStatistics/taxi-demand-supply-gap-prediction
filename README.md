...
This repository hosts a demo with code that trains a supervised predictive model based on past demand/supply patterns and (simulated) real-time taxi locations. Toy data used in this demo is provided by the [Kaggle Taxi Trajectory Prediction Challenge](https://www.kaggle.com/c/pkdd-15-predict-taxi-service-trajectory-i). This dataset contains GPS coordinates of the paths and starting times of each taxi trip in the city of Porto, Portugal, from July 1st, 2013 to June 30th, 2014. 
...
## Results ##
MAE in the hold-out dataset is 0.19, suggesting that the average difference between the actual gap and predicted gap is 0.19. Below is a snapshot of the live heatmap. Note that red implies a positive gap, which corresponds to unmet demand. Naturally we want to guide drivers to the red zones. 
